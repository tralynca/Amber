...
# output_TP_list = open("TP_list_for_Venn.txt", "w")
...
#     # #################################################################################################
                elif elem [0] and not operon == pred_operon \
...
#
                        ...
                        or (pred_operon_start == operon_start and pred_operon_end < operon_end) :
                            ...
                            if not pred_operon_name in TP_list \
                            and not pred_operon_name in FP_operon_counterpart \
                            and not pred_operon_name in FN_operon_counterpart \
                            and int(pred_operon.split(" - ")[1]) > int(pred_operon.split(" - ")[0]):
    ...
    #
                        ...
                        elif coverage == "NOT EXPRESSED" and pred_operon_end > pred_operon_start\
                            and pred_operon_single_start == operon_start \
                            or pred_operon_single_start == operon_end \
                            or pred_operon_single_end  == operon_start \
                            or pred_operon_single_end  == operon_end:
...
#################################################################
    ...
    set_TPs = set(TP_list)
    # output_TP_list.write(str(set_TPs))
    # output_TP_list.write(strain)
